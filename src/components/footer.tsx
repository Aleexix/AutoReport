            ...
            <div className="py-8">
                ...
                <div className="mt-6 text-center">
                    <ul className={`flex justify-center space-x-8 ${darkMode ? 'text-black ': 'text-white'}`} >
                        <li className="hover:text-blueI"><a href="#">{language === 'es' ? 'Ayuda':'Help'}</a></li>
                        <li className="hover:text-blueI"><a href="#">{language === 'es' ? 'Nosotros':'About'}</a></li>
                        <li className="hover:text-blueI"><a href="#">{language === 'es' ? 'Historico':'Historic'}</a></li>
