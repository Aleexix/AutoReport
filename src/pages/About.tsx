        ...
        <>
            <section className={`pt-10 overflow-hidden ${darkMode ? 'bg-body' : 'bg-white'}`}>
                <div className="container px-4 mx-auto">
                    ...
                    <img className="hidden md:block absolute top-52 right-24 z-10 w-12 h-12 object-contain" src="src/Images/star.svg" alt="" />
                    <img className="hidden md:block absolute top-56 right-32 z-10 w-12 h-12 object-contain" src="src/Images/star2.svg" alt="" />
                    ...
                    <img 
                        className="hidden md:block absolute bottom-0 right-0 w-1/3 max-w-md object-contain" 
                        src={`${darkMode ? 'src/Images/lines2.svg' : 'src/Images/Group 1.svg'}`} 
                        alt="" 
                    />
                            ...
                            <div className="w-full md:w-1/2 p-4 lg:p-12">
                                <div className="max-w-full mx-auto">
                                    <img 
                                        ...
                                        src="src/Images/freepik__background__77229.png" 
                                        alt="" 
                                    />
                                </div>
                            </div>
                                    ...
                                    <div className="w-1/2 p-2">
                                        <div className="flex flex-wrap">
                                            <div className="mb-4 w-full">
                                                <img className="w-full h-auto object-contain" src="src/Images/react-javascript-js-framework-facebook-svgrepo-com.svg" alt="" />
                                            </div>
                                            <div className="w-full">
                                                <img className="w-full h-auto object-contain" src="src/Images/vite-svgrepo-com.svg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="w-1/2 p-2">
                                        <div className="flex flex-wrap mt-12">
                                            <div className="mb-4 w-full">
                                                <img className="w-full h-auto object-contain" src="src/Images/tailwind-svgrepo-com.svg" alt="" />
                                            </div>
                                            <div className="w-full">
                                                <img className="w-full h-auto object-contain" src="src/Images/python-svgrepo-com.svg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="flex flex-wrap justify-center items-center text-center -m-4">
                        <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
                            <div className="text-center">
                                <img className="mb-6 mx-auto w-32 h-32 object-contain" src="src/Images/user-svgrepo-com.svg" alt="Imagen de alexix CEO de el software" />
                        ...
                        <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
                            <div className="text-center">
                                <img className="mb-6 mx-auto w-32 h-32 object-contain" src="src/Images/user-svgrepo-com.svg" alt="Imagen de Jhon" />
                                <span className={`inline-block mb-2 text-sm ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                                    FullStack
                                </span>
                                <h3 className={`text-2xl md:text-3xl ${darkMode ? 'text-white' : 'text-black'}`}>
