            ...
            <div className="flex flex-wrap -m-2 mb-10">
              ...
              <div className="w-full md:w-1/2 p-2">
                <div className={`relative mb-2 border overflow-hidden rounded-3xl ${darkMode ? ' border-white focus-within:border-blueI' : ' border-black focus-within:border-blueI'}`}>
                  <select className={`${darkMode ? 'pl-6 pr-16 py-4 text-gray-300 w-full placeholder-gray-400 outline-none bg-transparent':'pl-6 pr-16 py-4 text-black w-full placeholder-gray-400 outline-none bg-transparent'}`}>
                    <option hidden>{language === 'es' ? 'Locacion':'Location'}</option>
